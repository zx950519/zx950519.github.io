...
- 8.执行：cp spark-env.sh.template spark-env.sh，并按下面修改内容(类似设置JDK)
- 9.export SCALA_HOME=/mysoftware/scala-2.11.8;export JAVA_HOME=/mysoftware/jdk1.7.0_80;export SPARK_HOME=/home/ZHOU/SPARK;export SPARK_MASTER_IP=192.168.61.128;export SPARK_WORKER_MEMORY=512m;export master=spark://192.168.61.128:7070
