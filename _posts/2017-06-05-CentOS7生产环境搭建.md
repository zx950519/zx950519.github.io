...
```
    ...
    4.创建挂载点:mount -t nfs server_ip:/home/hadoop/share /home/hadoop/share //注释-服务器地址:/服务器下共享文件夹的路径 本地的共享文件夹路径
    5.查看挂载目录:df -h
    6.卸载挂载目录:umount /home/hadoop/share
    7.开机自动挂载:sudo vim /etc/fstab; 添加一行:server_ip:/home/hadoop/share /home/hadoop/share nfs rw,tcp,intr 0 1
```
#### 故障处理
```
